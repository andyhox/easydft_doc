...
class SlabModify:
    ...
    def fix_slab(cls, 
                 slab: Structure, 
                 min_fix_ratio: Union[float, None] = 0.2,
...
class HeterojunctionModify:
    ...
    """
    def __init__(self, film_structure: Structure,
    ...
    def gen_heter_interface(self,
        ...
        interfaces = self.cib.get_interfaces(termination=termination, gap=gap, vacuum_over_film=vacuum_over_film, 
